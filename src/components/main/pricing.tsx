...
export default function Pricing() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 ">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-[#0F172A] rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <a href="#" className=" bg-white text-black hover:bg-black hover:text-white focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Get started</a>
          </div>
